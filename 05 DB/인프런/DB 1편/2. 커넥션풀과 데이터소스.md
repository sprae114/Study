...
# 커넥션풀
#### ✔ 커넥션 풀(DBCP)이란?
출처 : [[Spring] 커넥션 풀(Connection pool)이란? · linked2ev](https://linked2ev.github.io/spring/2019/08/14/Spring-3-%EC%BB%A4%EB%84%A5%EC%85%98-%ED%92%80%EC%9D%B4%EB%9E%80/)
...
#### ✔ 커낵션풀 사용 매커니즘은?
- 초기화
커넥션 풀은 필요한 만큼 커넥션을 미리 확보해서 풀에 보관함. 이는 TCP/IP로 DB와 커넥션이 연결되어 있는 상태를 의미하기 때문에 언제든지 즉시 SQL을 DB에 전달가능함.
